...
SUBDIRS := control smart-data-engine internal-components user-interfaces security workflow hub-station admin-center about business-app development-center transformation migration-tools dev-data test-tools fulltext-search
