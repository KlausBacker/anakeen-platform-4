...
class TestDcpDocumentFilterOneDocumentTitle extends TestDcpDocumentFiltercommon
{
    ...
    /**
     * @param $test
     * @dataProvider dataOneDocumentTitle
     */
    public function testOneDocumentTitle($test)
    {
    ...
    public function dataOneDocumentTitle()
    {
        return array(
            // M_DOCID
            array(
