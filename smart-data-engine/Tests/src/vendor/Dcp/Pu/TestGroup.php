...
class TestGroup extends TestCaseDcpCommonFamily
{
    ...
    {
        // create user
        $user = SEManager::createDocument("IUSER");
        ...
        foreach ($groupLoginsToCreate as $gLogin) {
            /**
             * @var \SmartStructure\IGROUP $group
             */
            $group = SEManager::createDocument("IGROUP");
    ...
    public function testCreateGroup($login)
    {
         ...
         */
        $doc = SEManager::createDocument("IGROUP");
     ...
     * @dataProvider dataUserInsertDocument
     */
    public function testUserInsertDocument($userId, $groupId, $insertUserId)
    {
        /**
         * @var Iuser $user
         */
        ...
        $this->assertNotEmpty($groupAccount);
        /**
    ...
    public function dataUserInsertDocument()
    {
        return array(
            array(
                'U_1',
