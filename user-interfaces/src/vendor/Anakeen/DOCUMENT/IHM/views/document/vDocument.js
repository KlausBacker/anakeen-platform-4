...
import ModelDocumentTab from "../../models/mDocumentTab";
import ViewDocumentMenu from "../../views/document/menu/vMenu";
import ViewDocumentHeader from "../../views/document/header/vHeader";
import ViewAttributeFrame from "../../views/attributes/frame/vFrame";
import ViewAttributeTabLabel from "../../views/attributes/tab/vTabLabel";
import ViewAttributeTabContent from "../../views/attributes/tab/vTabContent";
import attributeTemplate from "../../views/document/attributeTemplate";
import ModelTransitionGraph from "../../models/mTransitionGraph";
import ViewTransitionGraph from "../../views/workflow/vTransitionGraph";
import i18n from "../../i18n/documentCatalog";
import * as EventPromiseUtils from "../../widgets/globalController/utils/EventUtils";
import "../../widgets/history/wHistory";
import "../../widgets/properties/wProperties";
