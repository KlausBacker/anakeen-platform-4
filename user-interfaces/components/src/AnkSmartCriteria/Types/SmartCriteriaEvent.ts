/**
 * Smart criteria event class
 */
class SmartCriteriaEvent {
  public type;
  public cancelable;
  public target;
  public data;
   ...
   */
  constructor(data = null, target = null, cancelable = true, type = "SmartCriteriaEvent") {
    this.type = type;
...
export default SmartCriteriaEvent;
