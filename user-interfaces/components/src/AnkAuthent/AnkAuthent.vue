  ...
  <section class="authent-component" ref="authentComponent">
    <div class="authent-form-connect" v-if="!resetPassword">
      <form ref="authentForm" class="authent-form">
        <label class="label" for="login" translate-context="Authent" v-translate
          >Identifier :</label
        >
        <input
          id="login"
        ...
        <div class="authent-buttons">
          <button
            ref="loginButton"
            class="authent-login-button k-primary"
            type="submit"
          >
      ...
      <div class="authent-help" ref="authentHelpContent" style="display:none">
        <p class="label" for="password" translate-context="Authent" v-translate>
          Help Content
        </p>
      </div>
      <form
        ref="authentForgetForm"
        class="authent-form authent-form--forget"
        style="display:none"
      >
        <label
          class="label"
          ...
          v-translate
          >Enter identifier or email address :</label
        >
        <input
          id="forgetlogin"
          class="authent-login form-control k-textbox"
        ...
        <div class="authent-buttons">
          <button
            ...
            type="submit"
          >
            <translate translate-context="Authent"
              >Send reset password ask</translate
            >
          </button>
        </div>
      </form>
    ...
    <form
      ...
      class="authent-form authent-form--resetpassword"
      v-if="resetPassword"
    >
      <ank-password
      ...
      <div class="authent-buttons">
        ...
        <button
          ref="authentGoHome"
          class="authent-login-home k-primary"
          v-if="!resetStatusFailed"
        >
          <translate translate-context="Authent"
    ...
    <div class="authent-bottom">
      <select
        ref="authentLocale"
        class="authent-locale"
        name="language"
        v-model="$language.current"
      >
        <option v-for="language in availableLanguages" :value="language.key">{{
          language.label
        }}</option>
      </select>
      <button
        ref="authentHelpButton"
        class="authent-help-button k-secondary"
        v-if="!resetPassword"
      >
      ...
      <button
        ...
        class="authent-forget-button k-secondary"
        v-if="!resetPassword"
      >
