            ...
            <div class="documentsList__documentsTabs__welcome__content__creation">
                ...
                <div class="documentsList__documentsTabs__welcome__content__inner--content">
                    <div class="btn-group" ref="buttonGroup">
                        <button v-for="c in collections" class="documentsList__documentsTabs__welcome__collection__button btn-default" @click.capture="onCreateDocumentClick(c.initid)">
