...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(6), __webpack_require__(64)))
...
exports.default = {
  mounted: function mounted() {
    ...
    this.$http.get('/sba/collections').then(function (response) {
      _this.collections = response.data.data.sample.collections;
      _this.updateKendoData();
      _this.selectCollection(_this.collections[0]);
    });
    var store = document.getElementById('a4-store');
    store.addEventListener('store-change', function (event) {
      var storeData = event.detail && event.detail.length ? event.detail[0] : null;
      _this.onStoreChange(storeData);
    });
    this.initKendo();
  },
  data: function data() {
  ...
  methods: {
    onToggleCollections: function onToggleCollections() {
      this.$emit('store-save', { action: 'toggleCollections', data: !this.showCollections });
    },
    onStoreChange: function onStoreChange(storeData) {
      if (storeData) {
    ...
    initKendo: function initKendo() {
      ...
      this.$(this.$refs.listView).kendoListView({
        ...
        template: this.$kendo.template('<div class="documentsList__collectionCard"><div class="documentsList__collectionCard__body"><div class="documentsList__collectionCard__heading">' + '<div class="documentsList__collectionCard__heading__content_icon"><img src="#: image_url#"  alt="#: html_label# image"/></div>' + '<span class="documentsList__collectionCard__heading__content_label">#:html_label#</span>' + '</div></div></div>'),
        selectable: 'single',
        change: onChange
      });
      function onChange() {
    ...
    updateKendoData: function updateKendoData() {
...
exports.default = {
  ...
  methods: {
      ...
      if (storeData) {
        switch (storeData.type) {
          case 'SELECT_COLLECTION':
            ...
            this.$http.get('/sba/collections/' + this.collection.ref + '/documentsList').then(function (response) {
              _this2.documents = response.data.data.sample;
              _this2.updateKendoData();
            });
            break;
        }
      }
    },
    onClickCollection: function onClickCollection(event, collection) {
    ...
    initKendo: function initKendo() {
      ...
      this.$(this.$refs.listView).kendoListView({
        dataSource: this.dataSource,
        template: this.$kendo.template('<div class="documentsList__documentCard"><div class="documentsList__documentCard__body"><div class="documentsList__documentCard__heading">' + '<img class="documentsList__documentCard__heading__content_icon" src="#: collection.image_url#"  alt="#: title# image"/>' + '<span>#:title#</span>' + '</div></div></div>'),
        selectable: 'multiple',
    ...
    updateKendoData: function updateKendoData() {
      ...
      this.dataSource.data(this.documents.map(function (d) {
        d.collection = _this3.collection;
        return d;
      }));
    }
  }
...
exports.default = {
  store: _config2.default,
  mounted: function mounted() {
    var _this = this;

    this.$store.subscribe(function (mutation, state) {
      _this.fireStoreChangeEvent(mutation, state);
    });
    document.addEventListener("DOMContentLoaded", function (event) {
      var components = document.getElementsByClassName('a4-component');
      for (var i = 0; i < components.length; i++) {
        components[i].addEventListener('store-save', function (event) {
          var action = event.detail && event.detail.length ? event.detail[0] : null;
  ...
  methods: {
    ...
    fireStoreChangeEvent: function fireStoreChangeEvent(mutation, state) {
      this.$emit('store-change', { type: mutation.type, data: mutation.payload, state: state });
    }
  }
};
...
var _vueCustomElement = __webpack_require__(20);

var _vueCustomElement2 = _interopRequireDefault(_vueCustomElement);

var _splitter = __webpack_require__(24);

var _splitter2 = _interopRequireDefault(_splitter);

var _collections = __webpack_require__(21);

var _collections2 = _interopRequireDefault(_collections);

var _documents = __webpack_require__(22);

var _documents2 = _interopRequireDefault(_documents);

var _openDocument = __webpack_require__(23);
...
_vue2.default.customElement('a4-store', _store2.default);
_vue2.default.customElement('a4-splitter', _splitter2.default);
_vue2.default.customElement('a4-collections', _collections2.default);
_vue2.default.customElement('a4-documents', _documents2.default);
_vue2.default.customElement('a4-open-document', _openDocument2.default);
...
var _mutationsTypes = __webpack_require__(16);
...
exports.default = {
  toggleCollections: function toggleCollections(_ref, show) {
    var commit = _ref.commit;

    commit(_mutationsTypes2.default.TOGGLE_COLLECTIONS, show);
  },
  selectCollection: function selectCollection(_ref2, collection) {
    var commit = _ref2.commit;

    commit(_mutationsTypes2.default.SELECT_COLLECTION, collection);
  },
  openDocument: function openDocument(_ref3, document) {
    var commit = _ref3.commit;

    commit(_mutationsTypes2.default.OPEN_DOCUMENT, document);
  },
  selectDocument: function selectDocument(_ref4, document) {
    var commit = _ref4.commit;

    commit(_mutationsTypes2.default.SELECT_DOCUMENT, document);
  }
};
...
var _getters = __webpack_require__(54);

var _getters2 = _interopRequireDefault(_getters);

var _emptyState = __webpack_require__(53);
...
exports.default = (_types$TOGGLE_COLLECT = {}, _defineProperty(_types$TOGGLE_COLLECT, _mutationsTypes2.default.TOGGLE_COLLECTIONS, function (state, show) {
  state.toggleCollections = show;
}), _defineProperty(_types$TOGGLE_COLLECT, _mutationsTypes2.default.SELECT_COLLECTION, function (state, collection) {
  state.selectedCollection = collection;
}), _defineProperty(_types$TOGGLE_COLLECT, _mutationsTypes2.default.OPEN_DOCUMENT, function (state, document) {
  state.openedDocuments.push(document);
}), _defineProperty(_types$TOGGLE_COLLECT, _mutationsTypes2.default.SELECT_DOCUMENT, function (state, document) {
  state.selectedDocument = document;
}), _types$TOGGLE_COLLECT);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "documentsList__openDocuments__wrapper"
  }, [(_vm.urlDocument) ? _c('iframe', {
    attrs: {
      "src": _vm.urlDocument
    }
  }) : _vm._e()])
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: "btn btn-default documentsList__documents__search__reset__button"
  }, [_c('span', {
    ...
    staticClass: "btn btn-default documentsList__documents__search__button"
  }, [_c('span', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ref: "splitter",
    staticClass: "documentsList__panel__wrapper"
  }, [_vm._t("leftPane"), _vm._v(" "), _c('div', {
    staticClass: "documentsList__collapsible__handler documentsList__collapsible__handler--panel documentsList__height_ignored"
  }, [_c('div', {
    staticClass: "documentsList__collapsible__handler__label"
  }, [_vm._v(_vm._s(_vm.collection ? _vm.collection.html_label : ''))])]), _vm._v(" "), _vm._t("default")], 2)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: ("documentsList__collections__wrapper" + (_vm.showCollections ? ' documentsList__collections--expanded': ''))
  }, [_c('div', {
    staticClass: "documentsList__collections"
  }, [_vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "documentsList__collections_buttons documentsList__collections_buttons--top"
  }, [_c('div', {
    staticClass: "documentsList__collections_button documentsList__collections_button--collapse",
    on: {
      "click": _vm.onToggleCollections
    }
  }, [_c('div', {
    staticClass: "documentsList__collections_button_icon documentsList__collections_button_icon--collapse"
  }, [_c('i', {
    class: ("fa fa-angle-double-" + (_vm.showCollections ? 'left': 'right'))
  })]), _vm._v(" "), _c('div', {
    staticClass: "documentsList__collections_button_title documentsList__collections_button_title--collapse"
  }, [_vm._v("\n                    Réduire\n                ")])]), _vm._v(" "), _vm._m(1)]), _vm._v(" "), _c('div', {
    ref: "listView",
    staticClass: "documentsList__collections__list"
  }), _vm._v(" "), _c('div', {
    staticClass: "documentsList__collections_buttons documentsList__collections_buttons--bottom"
  }, [_vm._m(2), _vm._v(" "), _vm._l((_vm.buttons), function(b) {
    return _c('div', {
      class: ("documentsList__collections_button documentsList__collections_button--" + (b.id))
    }, [_c('div', {
      class: ("documentsList__collections_button_icon documentsList__collections_button_icon--" + (b.id))
    }, [_c('i', {
      class: b.icon
    })]), _vm._v(" "), _c('div', {
      class: ("documentsList__collections_button_title documentsList__collections_button_title--" + (b.id))
    }, [_vm._v("\n                    " + _vm._s(b.title) + "\n                ")])])
  })], 2)])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "documentsList__collections_button_icon documentsList__collections_button_icon--user"
  }, [_vm._v("\n                Dp\n            ")]), _vm._v(" "), _c('div', {
    staticClass: "documentsList__collections_button_title documentsList__collections_button_title--user"
  }, [_vm._v("\n                Dynacase platform Master\n            ")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "documentsList__collections_button documentsList__collections_button--up"
  }, [_c('div', {
    staticClass: "documentsList__collections_button_icon documentsList__collections_button_icon--up"
  }, [_c('i', {
    staticClass: "fa fa-caret-up"
  })])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "documentsList__collections_button documentsList__collections_button--down"
  }, [_c('div', {
    staticClass: "documentsList__collections_button_icon documentsList__collections_button_icon--down"
  }, [_c('i', {
