...
], function (widget, defaultTestSuite, htmltextTestSuite, htmltextTestDestroy) {
    "use strict";

//    defaultTestSuite("htmltext : read", widget, {}, {value : "<p>Lorem <strong>Ispum</strong></p>"});
//    defaultTestSuite("htmltext : write", widget, {mode : "write", noDestroyTesting:true, noFixture:true}, {value : "<p>Lorem <strong>Ispum</strong></p>"});
//
