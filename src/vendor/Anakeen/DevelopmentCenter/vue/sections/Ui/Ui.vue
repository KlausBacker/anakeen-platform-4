...
export default {
  components: {
    ...
    "ui-views": resolve =>
      import("./ViewsConfiguration/ViewsConf.vue").then(module =>
        resolve(module.default)
      ),
    "ui-control": resolve =>
    ...
    "ui-masks": resolve =>
      import("./Masks/Masks.vue").then(module => resolve(module.default))
  },
  props: ["ssName", "uiSection", "mask", "control"],
  watch: {
    ssName(newValue) {
  ...
  methods: {
    onSubComponentMounted(ssName, componentName) {
      this.$emit(`${ssName}-${componentName}-ready`);
    },
