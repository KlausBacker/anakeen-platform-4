<template>
    <div class="grid-parent">
        <ank-se-grid v-if="searchId" url-config="/api/v2/smartstructures/dsearch/gridConfig/<collection>" :server-paging="true"
                     :server-sorting="true" :server-filtering="true" :collection="searchId" class="search-grid" :contextTitles="false" ref="searchGrid">
        </ank-se-grid>
    </div>
</template>
<script>
