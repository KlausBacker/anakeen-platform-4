<template>
    <div :class="`ank-hub-component-error ank-hub-component-error--${displayType}`">
        <i class="ank-hub-component-error-icon fa fa-warning" :title="titleMessage"></i>
        <span class="ank-hub-component-error-message" v-if="displayType==='CONTENT'">{{errorMessage}}</span>
    </div>
</template>
