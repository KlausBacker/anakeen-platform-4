...
create sequence SEQ_ID_ACTION;
     ...
     *
     * @param \Anakeen\Core\Internal\Application $parent
     *
     * @return string
     */
     ...
     * shorcut to \Anakeen\Core\Internal\Application::getParam
     *
     * @param string $name
     ...
     *
     * @see \Anakeen\Core\Internal\Application::getLayoutFile
     *
     * @param $layname
     *
     * @return string
    ...
    public function Init($app, $action_desc, $update = false)
    {
        ...
        if ($update) {
            ...
            foreach ($list as $k => $act) {
                /**
                 * @var \Anakeen\Core\Internal\Action $act
                 */
                $find = false;
