<template>
  <div class="views-grid-parent">
    <kendo-datasource
      ...
      :sort="[
        { field: 'cvId', dir: 'asc' },
        { field: 'viewMode', dir: 'asc' },
        { field: 'order', dir: 'asc' }
      ]"
    >
    </kendo-datasource>
    <kendo-grid
      ref="viewsGridContent"
      class="views-grid-content"
    ...
    >
      ...
      <kendo-grid-column
        ...
        :filterable-cell-show-operators="false"
        :filterable-cell-template="autoFilterCol"
        :template="displayLink('cvStructure')"
      ></kendo-grid-column>
      <kendo-grid-column
        :field="'viewId'"
        :title="'<b>View Name</b>'"
      ...
      ></kendo-grid-column>
      <kendo-grid-column
        :field="'renderConfigClass'"
        :title="'<b>Render Class</b>'"
        :filterable-cell-operator="'contains'"
        :filterable-cell-show-operators="false"
        :filterable-cell-template="autoFilterCol"
      ></kendo-grid-column>
