...
export default {
  ...
  data() {
    return {
      columnSizeTab: window.localStorage.getItem("param-list-values-column-size-conf-" + this.ssName)
        ? JSON.parse(window.localStorage.getItem("param-list-values-column-size-conf-" + this.ssName))
        : [],
      items: [
