<template>
  <div v-if="isReady" class="smart-structure-infos-section">
    <div class="smart-structure-title">
      ...
      <div class="smart-structure-toolbar">
        <div class="k-button-group create-buttons-group">
          <button class="k-button k-button-icontext k-primary" @click="onCreate">
            <i class="k-icon k-i-plus"></i>&nbsp;Create
          </button>
        </div>
        <div class="k-button-group view-buttons-group">
          <button class="k-button k-button-icontext" @click="onView('json')">
            <i class="k-icon k-i-css"></i>View JSON
          </button>
          <button class="k-button k-button-icontext" @click="onView('xml')">
            <i class="k-icon k-i-html"></i>View XML
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="smart-structure-infos-column">
        <div class="smart-structure-infos-card hierarchy-card">
          ...
          <div class="infos-card-content">
            <structure-hierarchy
              ...
              :current-structure="ssName"
              :data="structureHierarchy"
            ></structure-hierarchy>
            <div v-else style="text-align: center"><span>No inheritance</span></div>
          </div>
        </div>
          ...
          <div class="infos-card-content">
            <div class="infos-card-content-item">
              ...
              <span class="card-content-item-value"
                >{{ structureInfo.fields.leafCount }} / {{ structureInfo.fields.count }}</span
              >
            </div>
            <div class="infos-card-content-item">
              <span class="card-content-item-label">Number of parameters (Scalar parameters / All parameters): </span>
              <span class="card-content-item-value"
                >{{ structureInfo.parameters.leafCount }} / {{ structureInfo.parameters.count }}</span
              >
            </div>
          </div>
        </div>
        <div class="smart-structure-infos-card">
          ...
          <div class="infos-card-content">
            ...
            <div class="infos-card-content-item">
              ...
              <span class="card-content-item-value"
                >{{ structureInfo.elements.count }} ({{ structureInfo.elements.countWithChilds }})</span
              >
            </div>
            <div class="infos-card-content-item">
              ...
              <span v-if="structureInfo.revision.isRevisable" class="card-content-item-value"
                >(max revision:
                {{ structureInfo.revision.maxRevision ? structureInfo.revision.maxRevision : "&infin;" }})</span
              >
            </div>
          </div>
        </div>
        <div class="smart-structure-infos-card">
          ...
          <div class="infos-card-content" style="display: flex; justify-content: center; align-items: center;">
            <infos-nav :info-sections="otherInfoSections"></infos-nav>
          </div>
        </div>
      </div>
      <div class="smart-structure-infos-column">
        <div class="smart-structure-infos-card">
          ...
          <div class="infos-card-content">
            <properties-view :element-id="ssName"></properties-view>
          </div>
        </div>
      </div>
    </div>
...
<script src="./Infos.controller.js"></script>
