<template>
  ...
  >
    ...
    <div class="splitter-wrapper-right-content">
      <div v-if="splitterEmpty" class="splitter-empty">
        <div class="splitter-empty-content">
          <slot class="splitter-empty-icon" name="emptyIcon"
            ><span class="k-icon k-i-information splitter-empty-icon"></span
          ></slot>
          <slot class="splitter-empty-text" name="emptyText"
            ><span class="splitter-empty-text"> Please select an element to open </span>
          </slot>
        </div>
      </div>
