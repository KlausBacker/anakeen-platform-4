 ...
 * Get Structure info
 *
 * @note Used by route : GET /api/v2/admin/smart-structures/{structure}/fields/
 */
class StructureFields
{
    ...
    public function doRequest()
    {
        ...
        $data["uri"] = URLUtils::generateURL(Settings::ApiV2 . sprintf("admin/smart-structures/%s/fields/", $this->structureName));
        return $data;
    }
