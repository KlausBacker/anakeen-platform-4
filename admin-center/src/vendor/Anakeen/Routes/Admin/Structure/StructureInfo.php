 ...
 * Get Structure info
 *
 * @note Used by route : GET /api/v2/admin/smart-structures/{structure}/info/
 */
class StructureInfo
{
    ...
    public function doRequest()
    {
        ...
        $data = $df->getData();
        $data["uri"] = URLUtils::generateURL(Settings::ApiV2 . sprintf("admin/smart-structures/%s/info/", $this->structureName));
