...
class ImportHubComponentAdminParameters extends ImportHubComponentGeneric
{
    ...
    protected function getCustomMapping()
    {
        ...
        $mapping = [
            ...
            "display-global-parameters" => ParametersFields::admin_hub_configuration_global,
            "specific-user" => ParametersFields::admin_hub_configuration_account,
            ...
            "display-users-parameters" => ParametersFields::admin_hub_configuration_user,
        ];
