...
const conf = {
  moduleName: "enumManager",
  libName: "AdminEnumManager",
  entry: {
    "enum-manager": [path.resolve(BASE_DIR, "src/vendor/Anakeen/AdminCenter/IHM/HubComponent/AdminCenterEnum/index.js")]
  },
