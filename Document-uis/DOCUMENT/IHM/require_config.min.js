...
(function ()
{
    ...
    var config = {
        ...
        paths: {
            ...
            "datatables.net": "../lib/jquery-dataTables/1.10/js/jquery.dataTables.min",
            "datatables": "../lib/jquery-dataTables/1.10/js/jquery.dataTables.min",
            "datatables-bootstrap": "../lib/jquery-dataTables/1.10/js/dataTables.bootstrap.min",
            "es6-promise" : "../lib/es6-promise/es6-promise.min"
        },
        map: {
