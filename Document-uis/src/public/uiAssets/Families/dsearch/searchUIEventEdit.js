...
require.config({
    "paths": {
        "dcpDocGrid": "../DOCUMENT_GRID_HTML5/widgets/",
        "datatables.net" :       "../uiAssets/externals/jquery-dataTables/js/jquery.dataTables.min",
        "datatables-bootstrap": "../uiAssets/externals/jquery-dataTables/js/dataTables.bootstrap",
...
require([
    'jquery',
    'underscore',
    'dcpContextRoot/uiAssets/Families/dsearch/searchUIGrid',
    'dcpDocGrid/documentGrid'
], function ($, _, showGrid) {
