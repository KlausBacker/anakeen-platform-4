        ...
        structureFiles.forEach(structureFile => {
            if (structureFile.structure) {
                Object.keys(structureFile.structure).forEach(currentStructureName => {
                    const currentStructure = structureFile.structure[currentStructureName];
                    let structureRef = workingStructure[currentStructure.name] ? workingStructure[currentStructure.name] : {};
                    ...
                    if (currentStructure.extends) {
                        ...
                        workingStructure[currentStructure.extends].children[structureRef.name] = structureRef;
                    }
