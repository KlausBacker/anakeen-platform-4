export default {
  ...
  methods: {
    ...
    fetchUser() {
      this.$http.get("/api/v2/ui/users/current").then(response => {
    ...
    openEmailModifierWindow() {
      ...
      if (this.emailAlterable) {
        ...
        let resetEmailChangeData = () => {
          this.oldPassword = "";
          document
            .getElementById("oldPasswordInputEmail")
            .publicMethods.setValue("");
          this.newEmail = "";
    ...
    openPasswordModifierWindow() {
      ...
      if (this.passwordAlterable) {
        ...
        let resetPasswordChangeData = () => {
          ...
          document
            .getElementById("passwordConfirmationInput")
            .publicMethods.setValue("");
