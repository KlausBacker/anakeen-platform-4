...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Apps/DOCUMENT_GRID_HTML5/widgets/documentGrid.js");
/******/ })
/************************************************************************/
/******/ ({
...
(function (factory) {
	if (true) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("external \"jQuery\""), __webpack_require__("./node_modules/datatables.net/js/jquery.dataTables.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
...
(function (factory) {
	...
	if (true) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("external \"jQuery\"")], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
			return factory($, window, document);
		}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') {
...
/***/ "./src/Apps/DOCUMENT_GRID_HTML5/widgets/docGrid.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".filter {\n    width: 100%;\n}\n\n.colorElement {\n    width: 25px;\n    height: 25px;\n}\n\n.multiple.firstLevel {\n    display: block;\n    padding-top: 0.2em;\n}\n\nspan.stateColor {\n    border-style: none none none solid;\n    padding-left: 3px;\n    border-width: 0 10px 1px 10px;\n    text-decoration: none;\n}\n\n.removeButton {\n    padding : 0;\n    border : none;\n}\n\n.type--money {\n    text-align: right;\n}\ndiv.dataTables_processing {\n    background: #008dc5;\n    color:white;\n}\n\n.dg-selectcolumn-menu {\n\n    position:absolute;\n    top:0;\n    right:0;\n}\n.dg-selectcolumn-menu > li{\n    width:100%;\n}\n.dg-selectcolumn-menu > li.k-item span.k-link {\n    padding: 7px 7px;\n}\n.dg-selectcolumn-menu .k-animation-container > ul {\n    max-height: 90vh;\n}\n\n.document-grid th {\n    position:relative;\n}\n\n.dg-selectcolumn li {\n    font-weight: normal;\n}\n\n\n.dg-selectcolumn >  li.dg-select-visible {\n    font-weight: bold;\n}\n\n.dg-selectcolumn >  li .k-link:before {\n    content :\" \\F1DB\";\n    font-family: FontAwesome;\n    margin-right: 3px;\n}\n\n.dg-selectcolumn >  li.dg-select-visible .k-link:before {\n   content :\" \\F00C\";\n    font-family: FontAwesome;\n    margin-right: 3px;\n}\nimg.docIcon.gridIcon {\n    vertical-align: top;\n    margin-right: 2px;\n}\ntable.document-grid {\n    table-layout: auto;\n}\n\ntable.document-grid thead th {\n  min-width:5em;\n}\ntable.document-grid thead th.cell-openDoc {\n    min-width:inherit;\n}\ntable.document-grid td {\n    overflow:hidden;\n}", ""]);
...
/***/ "./src/Apps/DOCUMENT_GRID_HTML5/widgets/documentGrid.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;

__webpack_require__("./src/Apps/DOCUMENT_GRID_HTML5/widgets/docGrid.css");
...
(function initGrid() {
    ...
    var init_grid = function require_grid(_, $) {
                ...
                $kendoWindow.kendoWindow({
                    ...
                    open: function onOpen() {
                        ...
                        $kendoWindow.find("iframe").on("load", function onLoad() {
                            ...
                            if (doc && doc.location && doc.location.href && doc.location.href.toLowerCase().indexOf("images/1x1.gif") > -1) {
        ...
        var columnRender = {
             ...
             * @private
             */
            _multiplicatorAttributeAnalysis: function _multiplicatorAttributeAnalysis(value, formatterCallBack) {
                var htmlValue = "";
                formatterCallBack = formatterCallBack || function defaultFormatter(data) {
                    return data;
                };
                if (_.isArray(value)) {
                    value = _.map(value, function map(currentValue) {
                        if (_.isArray(currentValue)) {
                            currentValue = _.map(currentValue, function map(currentValue) {
                                return '<span class="multiple secondLevel">' + formatterCallBack(currentValue) + '</span>';
                            });
                    ...
                    _.each(value, function each(currentValue) {
                        htmlValue += '<span class="multiple firstLevel">' + currentValue + '</span>';
                    });
                } else {
            ...
            _icon: function _icon(data) {
                var icon = data.icon || "";
                if (icon) {
                    return '<img class="docIcon gridIcon" src="' + htmlEncode(icon) + '"/>';
                }
                return '';
            },
            /**
            ...
            state: function state(cellData) {
                ...
                if (this.withColor && currentState.color) {
                    html = '<span class="stateText stateColor" style="border-color: ' + htmlEncode(currentState.color) + '">' + htmlEncode(label) + '</span>';
                } else if (label) {
            ...
            title: function title(cellData) {
                ...
                html += '<span class="docTitle">' + htmlEncode(currentTitle) + '</span>';
                return html;
            },
            /**
            ...
            openTitle: function openTitle(cellData) {
                ...
                if (url) {
                    html += $('<a/>').addClass("openDoc overlay").attr("href", url).attr("data-docid", cellData.properties.initid).attr("data-revision", cellData.properties.revision).text(cellData.properties.title)[0].outerHTML;
                } else {
                    html += title;
                }
                return html;
            ...
            openDoc: function openDoc(cellData) {
                var url = columnRender.prepareUrl(cellData),
                    html = '';
                if (url) {
                    html += $('<a><span class="glyphicon glyphicon-new-window"></span></a>').addClass("openDoc overlay btn btn-default btn-xs").attr("href", url).attr("data-docid", cellData.properties.initid).attr("data-revision", cellData.properties.revision)[0].outerHTML;
                }
                return html;
            },
            /**
            ...
            docid: function docid(cellData) {
                ...
                value = columnRender._multiplicatorAttributeAnalysis(value, function formatter(data) {
                    var html = "",
                    ...
                    if (data.value) {
                        ...
                        html += $('<a/>').addClass("openDoc overlay").attr("href", url).attr("data-docid", data.initid).attr("data-revision", revision).text(data.displayValue)[0].outerHTML;
                    } else {
            ...
            file: function file(cellData) {
                ...
                value = columnRender._multiplicatorAttributeAnalysis(value, function formatter(data) {
                    ...
                    if (data.url) {
                        html += '<a href="' + data.url + '">' + htmlEncode(data.displayValue) + '</a>';
                    } else {
            ...
            color: function color(cellData) {
                ...
                value = columnRender._multiplicatorAttributeAnalysis(value, function formatter(data) {
                    if (data.value) {
                        return '<div class="colorElement" style="background-color: ' + htmlEncode(data.value) + '"></div>';
                    } else {
                        return "";
                    }
                });
        ...
        var serverData = function serverData(data, callback) {
            ...
            if (this.options.autoload) {
                ...
                if (this.options.dataTableOptions.columnDefs) {
                    ...
                    url += "fields=";
                    putFirst = true;
                    _.each(this.options.dataTableOptions.columnDefs, function iterateColumn(columnContent) {
                        if (!columnContent.id) {
                            return;
                        }
                        if (isProperty(columnContent.id)) {
                            url += "document.properties." + window.encodeURIComponent(columnContent.id) + ",";
                        } else {
                            url += "document.attributes." + window.encodeURIComponent(columnContent.id) + ",";
                        }
                    });
                ...
                if (filters) {
                    url = addSeparator(url);
                    url += "filters=" + window.encodeURIComponent(JSON.stringify(filters));
                }
                if (data.start) {
                    url = addSeparator(url);
                ...
                if (data.order && data.order[0] && _.isNumber(data.order[0].column) && data.order[0].dir) {
                    order = _.find(this.options.dataTableOptions.columnDefs, function findElement(currentColumn) {
                        return currentColumn && currentColumn.targets === data.order[0].column;
                    });
                ...
                if (!this.options.temporarySearch) {
                    ...
                    $.post(url, constructData).pipe(function success(response) {
                        if (response.success) {
                            currentWidget.options.temporarySearch = response.data.searchContentUrl;
                            return response;
                        } else {
                    ...
                    $.get(url).pipe(function success(response) {
                        if (response.success) {
                            return response;
                        } else {
                            return $.Deferred().reject(response);
        ...
        $.widget("dcp.docGrid", {
            ...
            _dataTableDefaultOptions: {
                dom: "<'row'<'col-sm-12'<'pull-left'>l<'clearfix'>>>rt<' dt-info'<'col-sm-12'<'pull-left'i><'pull-right'p><'clearfix'>>>",
                pagingType: "full",
                serverSide: true,
                autoWidth: false,
                processing: true,
            ...
            _create: function _create() {
                ...
                if (!this.options.offlineColumnsDef && this.options.columnsDef && this.options.columnsDef.columns) {
                    sendData.columns = _.map(_.filter(this.options.columnsDef.columns, function filter(currentValue) {
                        return currentValue.id !== undefined;
                    }), function map(currentColumns) {
                        return currentColumns.id;
                    });
                    if (sendData.columns.length > 0) {
                        this._handleAjaxRequest($.getJSON(this.options.columnsDefUrl, {
            ...
            getFilters: function getFilters() {
                ...
                this.element.find("input.filter").each(function each() {
                    ...
                    if ($this.attr("data-type")) {
                        if ($this.attr("data-type") === "enum" || $this.attr("data-type") === "state") {
            ...
            _setOption: function _setOption(key, value) {
                if (key === "criterias") {
                    ...
                    this._error(["Unable to change option " + key + " you have to destroy the docgrid and rebuild it to change this option"]);
                    return;
                }
            },
            ...
            _error: function _error(error, event) {
                ...
                $("<pre/>").addClass("grid-error").text(error).kendoWindow({
                    title: "Error",
                    height: "auto"
            ...
            _handleAjaxRequest: function _handleAjaxRequest(requestObject, success, fail) {
                //noinspection JSCheckFunctionSignatures
                requestObject.pipe(function success(response) {
                    if (response.success) {
                        return response;
                    } else {
                        return $.Deferred().reject(response);
            ...
            _mergeColumnsDef: function _mergeColumnsDef(data) {
                ...
                this.options.columns = _.union(this.options.columns, _.map(this.options.columnsDef.columns, function map(currentInitialColumn) {
                    var mergedColumn, currentDataColumn;
                    currentDataColumn = _.find(displayColumns, function find(currentDataColumn) {
                        return currentDataColumn.id === currentInitialColumn.id;
                    });
                    mergedColumn = _.extend({}, currentDataColumn, currentInitialColumn);
            ...
            _addSelectColumn: function _addSelectColumn() {
                ...
                _.each(this.visibleColumns, function (item) {
                    var $li = $("<li/>").text(item.label).data("attrid", item.id);
            ...
            reload: function DGReload() {
                ...
                this.element.DataTable().destroy();
                this.element.empty();
                this.options.columnsDef.columns = _.filter(this.options.columnsDef.columns, function (colItem) {
            ...
            _initiateHeader: function _initiateHeader() {
                var $tr,
                    ...
                    if (currentWidget.options.dataTableOptions.columnDefs !== undefined && currentWidget.options.dataTableOptions.columnDefs[target] !== undefined && currentWidget.options.dataTableOptions.columnDefs[target] !== null && currentWidget.options.dataTableOptions.columnDefs[target].visible === false) {
                        return;
                    }
                    HeaderElement[target] = _.isFunction(currentHeaderCallback) ? currentHeaderCallback(currentColumn) : currentHeaderCallback;
                },
                    htmlElement = "";
                $tr = $("<tr />");
                ...
                _.each(this.options.dataTableOptions.columnDefs, _.bind(analyseColumns, this));
                ...
                $tr.find("[data-type=enum]").each(function eachEnum() {
                    var $this = $(this);
                    currentWidget._initComboBox($this, currentWidget, _.template(currentWidget.options.filterEnumContentUrl), {
                        famId: $this.attr("data-famId"),
                ...
                $tr.find("[data-type=state]").each(function eachState() {
                    var $this = $(this);
                    currentWidget._initComboBox($this, currentWidget, _.template(currentWidget.options.filterStateContentUrl), {
                        famId: $this.attr("data-famId")
                    });
                });
            },
            ...
            _initiateFooter: function _initiateFooter() {
                var $tr,
                    ...
                    HeaderElement[target] = currentWidget.options.dataTableOptions.columnDefs[target];
                };
                $tr = $("<tr />");
            ...
            _generateDataTableOptions: function _generateDataTableOptions() {
                ...
                if (this.options.dataTableOptions.columnDefs) {
                    this.options.dataTableOptions.columnDefs = _.union(options.columnDefs, this.options.dataTableOptions.columnDefs);
                }
                options = _.extend(options, this._dataTableDefaultOptions, this.options.dataTableOptions);
            ...
            _HeaderFilterRender: {
                ...
                simple: function simple(value) {
                    ...
                    if (value.id && value.filterable) {
                        ...
                        if (kind === "enum") {
                            return '<div class="form-group"><div class="input-group"><input class="filter enumFilter combobox" ' + 'type="text" ' + 'data-id="' + id + '" data-famId="' + value.famId + '" data-type="' + kind + '"/>' + '<div class="input-group-addon removeButton">' + '<button class="btn btn btn-default"><span class="glyphicon glyphicon-remove"></span></button>' + '</div></div></div>';
                        } else if (kind === "state") {
                            return '<div class="form-group"><div class="input-group"><input class="filter stateFilter combobox" ' + 'type="text" ' + 'data-id="' + id + '" data-famId="' + value.famId + '" data-type="' + kind + '"/>' + '<div class="input-group-addon removeButton">' + '<button class="btn btn btn-default"><span class="glyphicon glyphicon-remove"></span></button>' + '</div></div></div>';
                        } else {
                            return '<input class="filter textFilter k-textbox" ' + 'type="search" ' + 'data-id="' + id + '" data-famId="' + value.famId + '" data-type="' + kind + '"/>';
                        }
                    }
                    return "";
                }
            ...
            _initComboBox: function _initComboBox(element, currentWidget, url, additionnalData) {
                    ...
                    dataSource: {
                        ...
                        transport: {
                            ...
                            parameterMap: function mapsParameters(data, type) {
                                if (data.filter && data.filter.filters && data.filter.filters.length && data.filter.filters[0] && _.isString(data.filter.filters[0].value)) {
                        ...
                        schema: {
                            data: function parseData(response) {
                                if (!response.success) {
                                    throw new Error("Unable to read the return of helpers " + response.messages || "");
                                }
                ...
                element.closest(".form-group").on("click", ".btn", function buttonClick() {
    ...
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/underscore/underscore.js"), __webpack_require__("external \"jQuery\""), __webpack_require__("./src/Apps/DOCUMENT/IHM/widgets/widget.js"), __webpack_require__("./node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function require_grid(_, $) {
            init_grid(_, $);
        }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else {
...
//# sourceMappingURL=smartElementGrid.js.map